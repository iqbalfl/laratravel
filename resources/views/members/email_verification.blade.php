      ...
      <table width="790" cellspacing="0" cellpadding="0" class="container" style="width: 790px; padding: 20px;">
          <tr>
              <td>
                  <table width="100%" cellspacing="0" cellpadding="0" style="width: 100%; padding-bottom: 20px;">
                      <tbody>
                          <tr style="font-size: 20px; font-weight: 600;">
                            <td style="padding-bottom: 5px; border-bottom: 1px solid #F1F1F2;">
                                <span>Informasi Order - BandungTranService</span>
                            </td>
                          </tr>
                          <tr>
                                      ...
                                      <tr style="font-size: 13px;">
                                          <td>
                                              <table style="width: 100%; border-collapse: collapse;" width="100%" cellspacing="0" cellpadding="0">
                                                  <tbody>
                                                      <tr>
                                                          <td style="width: 90px; font-weight: 600; padding: 3px 20px 3px 0;" width="80">Kd Transaksi</td>
                  ...
                  <table width="100%" cellspacing="0" cellpadding="0" style="width: 100%;border-bottom: 1px solid #F1F1F2; padding: 0 0 20px;">
                      <tbody>
                          <tr>
                              ...
                              <td width="65%" valign="top" style="width: 65%; vertical-align: top; padding-left: 5px;">
                                  <table width="100%" cellspacing="0" cellpadding="0" width="100%" style="width: 100%; border-collapse: collapse;">
                                      <tr bgcolor="#F1F1F1" style="font-size: 15px; color: #42B549; background-color: #F1F1F1;">
                                          ...
                                          <td style="padding: 15px 30px 15px 0; font-weight: 600; text-align: right; ">Rp {{$transaction->total_cost}}</td>
                                      </tr>
                                  </table>
                              </td>
                          </tr>
                  ...
                  <p style="font-size: 13px;">
                    #Segera lakukan pembayaran, dan konfirmasi
                    <a href="{{url('/member/orders/confirmation', $transaction->id)}}">disini!</a>
                  </p>
              </td>
          </tr>
      </table>
